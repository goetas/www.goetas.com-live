...
<head>        <meta charset="utf-8">
        <title>Technologies -Asmir Mustafic</title>
        ...
        <meta property="og:url" content="https://www.goetas.com/technologies/page/3.md" />

        <meta name="twitter:title" content="Technologies -Asmir Mustafic" />
        <meta name="og:title" content="Technologies -Asmir Mustafic" />
...
<section class=" roomy-50 m-top-100">
    <div class="container">
        <div class="breadcrumb">                <h1>Technologies</h1>
        </div><div class="tech-cloud">

<p>Here you can find a list of technologies that I'm familiar with:</p>
...
<p><br>
More can be found visiting my <a href="https://linkedin.com/in/goetas">LinkedIn</a> profile.
I provide my services as <a href="/freelance/">freelance web developer</a> available in Berlin or Remote all over the world.</p>    </div>
                ...
                <div class="maine_action">
                    <div class="col-md-8">
                        <div class="action_item text-center">
                            <h4 class="text-white text-uppercase">Need an expert for one of this technologies?                            </h4>
                        </div>
                    </div>
                    <div class="col-md-4">
